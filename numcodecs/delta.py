...
from .compat import ensure_ndarray, memory_copy
...
class Delta(Codec):
    ...
    def encode(self, buf):
        ...
        arr = ensure_ndarray(buf).reshape(-1, order='A').view(self.dtype)
    ...
    def decode(self, buf, out=None):
        ...
        enc = ensure_ndarray(buf).reshape(-1, order='A').view(self.astype)
